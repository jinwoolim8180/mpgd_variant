...
def main():
    ...
    parser.add_argument('--cs_ratio', type=float, default=10)
    ...
    task_config["conditioning"]["params"]["scale"] = args.cs_ratio
    ...
    # Working directory
    dir_path = f"{diffusion_config['timestep_respacing']}_eta{args.eta}_scale{args.cs_ratio}"
